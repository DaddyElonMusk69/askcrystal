...
import { handleChat, handleChatParameters, handleChatStop, handleChatStream, handleChatSuggestions } from './routes/chat.mjs'
...
const routeTable = {
  ...
  [`POST ${ROUTES.chatSuggestions}`]: async req => handleChatSuggestions(await readJson(req)),
