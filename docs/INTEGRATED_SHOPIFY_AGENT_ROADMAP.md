...
- `docs/LOCAL_DIFY_ROADMAP.md`
- `docs/AGENT_BEHAVIOR_PRD_ALIGNMENT.md`
- `docs/SHOPIFY_HOME_AGENT_PLAN.md`
...
2. `Storefront integration`
   - Shopify app, app proxy, theme app extension, homepage block.
   - repo workspace: `apps/shopify/`
