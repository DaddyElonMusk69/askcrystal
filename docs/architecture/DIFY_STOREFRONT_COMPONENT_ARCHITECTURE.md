...
- Shopify proxy support in `deployables/shopify-app/src/server/dify/local-dify-gateway.mjs`
...
- A local Dify bootstrap app snapshot in `services/dify-agent/dsl/askcrystal-storefront-components-chatflow-2026-04-24.dsl.yml`
  - advanced-chat app
  - deterministic code-node output
  - no model dependency required
- Provisioning automation in `scripts/build/provision_storefront_component_flow.py`
- Proxy smoke test in `scripts/dev/smoke_storefront_component_proxy.py`
...
- `services/dify-agent/dsl/askcrystal-agent-2026-04-23.dsl.yml`
...
- `schema_version`
  - Currently `1`.
- `components`
  - Ordered array of component intents following `services/dify-agent/manifests/storefront-components/storefront-component-intent.schema.json`
...
- Dify-side component intent schema:
  - `services/dify-agent/manifests/storefront-components/storefront-component-intent.schema.json`
- Dify-side example payload:
  - `services/dify-agent/manifests/storefront-components/examples/sleep-grounding.json`
- Frontend render contract:
  - `packages/storefront-ui-contract/src/chat-components.mjs`
