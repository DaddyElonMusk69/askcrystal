...
5. Upload KB docs produced by `scripts/build/prepare_dify_kb.py`.
...
Then upload `data/knowledge-base/dify_kb_docs` into Dify Knowledge as documents.
...
1. Add each skill as a YAML entry in `services/skill-bridge/src/dify_skill_bridge/skills/`.
