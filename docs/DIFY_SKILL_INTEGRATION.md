...
Expose local skill packs as Dify custom tools through `dify_skill_bridge`.
...
- Bridge app: `dify_skill_bridge/server.py`
- Skill packs:
  - `dify_skill_bridge/skills/mythology_pack.(yml|json)`
  - `dify_skill_bridge/skills/cn_divination_pack.(yml|json)`
  - `dify_skill_bridge/skills/astrology_crystal_pack.(yml|json)`
- Registration script: `scripts/register_skill_bridge_tools.py`
- App tool sync script: `scripts/sync_agent_skill_tools.py`
...
```bash
cd /Users/haokaiqin/Desktop/AskCrystal/dify-local/docker
...
- `docs/dify_skill_routing_prompt.md`
