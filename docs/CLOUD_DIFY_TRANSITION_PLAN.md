...
2. version the DSL in `agent/dify/dsl/`,
...
- `crystal_knowledge_base_final-90b679ba5d.json`
- `dify_kb_docs/`
...
- `dify_skill_bridge/`
- `scripts/register_skill_bridge_tools.py`
- `scripts/sync_agent_skill_tools.py`
- `scripts/setup_shopify_mcp_direct.py`
...
2. save it as a versioned repo artifact under `agent/dify/dsl/`,
...
- the entire local `dify-local/` runtime clone,
...
- Shopify implementation in `apps/shopify/` should target the cloud-ready agent contract,
