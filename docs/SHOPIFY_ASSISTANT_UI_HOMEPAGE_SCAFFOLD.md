...
- `apps/askcrystal-horizon/frontend/assistant-ui/`
...
- `apps/askcrystal-horizon/sections/askcrystal-home.liquid`
- `apps/askcrystal-horizon/templates/index.json`

## Frontend Source

- `apps/askcrystal-horizon/frontend/assistant-ui/main.jsx`
- `apps/askcrystal-horizon/frontend/assistant-ui/styles.css`

## Build Config

- `apps/askcrystal-horizon/vite.askcrystal.config.mjs`
- `apps/askcrystal-horizon/package.json`

## Built Theme Assets

- `apps/askcrystal-horizon/assets/askcrystal-homepage.js`
- `apps/askcrystal-horizon/assets/askcrystal-homepage.css`
