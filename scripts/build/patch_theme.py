...
FIXTURE_DIR = ROOT / "data" / "fixtures" / "shopify-theme-patch"

# Update index.json
with (FIXTURE_DIR / "index.json").open("r", encoding="utf-8") as f:
...
with (FIXTURE_DIR / "index_updated.json").open("w", encoding="utf-8") as f:
    json.dump(index_data, f, indent=2)

# Update settings_data.json
with (FIXTURE_DIR / "settings_data.json").open("r", encoding="utf-8") as f:
...
with (FIXTURE_DIR / "settings_data_updated.json").open("w", encoding="utf-8") as f:
