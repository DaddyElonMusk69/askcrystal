...
DEFAULT_DSL_PATH = REPO_ROOT / "services" / "dify-agent" / "dsl" / "askcrystal-shushu-workflow-2026-04-26.dsl.yml"
WORKFLOW_TOOL_NAME = "workflow_shushu_numerology_profile"
WORKFLOW_TOOL_LABEL = "Shushu Numerology Profile"
WORKFLOW_TOOL_DESCRIPTION = (
    "Builds a lightweight birthday-pattern numerology contract for the main AskCrystal agent to interpret."
)
...
WORKFLOW_TOOL_PARAMETERS = [
    {
        "name": "birth_date",
        "description": "The birth date to use for the profile, ideally in YYYY-MM-DD format.",
        "form": "llm",
    },
    {
        "name": "name",
        "description": "Optional name used only as light context for tone and personalization.",
        "form": "llm",
    },
    {
        "name": "analysis_focus",
        "description": "Optional focus area such as confidence, career, relationships, reset, or emotional pattern. Include the AskCrystal runtime year for current personal-year requests.",
        "form": "llm",
    },
]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Import, publish, and register the AskCrystal shushu numerology workflow as a Dify workflow tool."
    )
    ...
    parser.add_argument("--publish-marked-name", default="Shushu workflow", help="Release marker name shown in Dify workflow history.")
