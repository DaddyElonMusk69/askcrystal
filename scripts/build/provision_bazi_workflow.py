...
DEFAULT_DSL_PATH = REPO_ROOT / "services" / "dify-agent" / "dsl" / "askcrystal-bazi-workflow-2026-04-26.dsl.yml"
WORKFLOW_TOOL_NAME = "workflow_bazi_chart_analysis"
WORKFLOW_TOOL_LABEL = "Bazi Chart Analysis"
WORKFLOW_TOOL_DESCRIPTION = (
    "Builds a deterministic Four Pillars chart contract for the main AskCrystal agent to interpret with practical non-fatalistic guidance."
)
...
WORKFLOW_TOOL_PARAMETERS = [
    {
        "name": "birth_datetime",
        "description": "Birth date and time for the Bazi reading. Prefer a clear solar/Gregorian format such as 1994-11-03 08:40.",
        "form": "llm",
    },
    {
        "name": "gender",
        "description": "Gender marker used for the DaYun direction in this workflow version.",
        "form": "llm",
    },
    {
        "name": "birth_place",
        "description": "Optional birthplace for chart framing and later timing refinement.",
        "form": "llm",
    },
    {
        "name": "calendar_note",
        "description": "Optional note such as solar, Gregorian, lunar, leap month, or approximate time context.",
        "form": "llm",
    },
    {
        "name": "user_goal",
        "description": "Optional focus area such as career, relationship, timing, or energy pattern.",
        "form": "llm",
    },
]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Import, publish, and register the AskCrystal Bazi workflow as a Dify workflow tool."
    )
    ...
    parser.add_argument("--publish-marked-name", default="Bazi workflow", help="Release marker name shown in Dify workflow history.")
