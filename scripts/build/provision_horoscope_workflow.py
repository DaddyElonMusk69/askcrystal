...
DEFAULT_DSL_PATH = REPO_ROOT / "services" / "dify-agent" / "dsl" / "askcrystal-horoscope-workflow-2026-04-26.dsl.yml"
...
WORKFLOW_TOOL_PARAMETERS = [
    {
        "name": "question",
        "description": "The user's horoscope or Western zodiac request.",
        "form": "llm",
    },
    {
        "name": "zodiac_sign",
        "description": "Optional Western zodiac sign such as Scorpio, Aries, Gemini, or Pisces.",
        "form": "llm",
    },
    {
        "name": "birth_date",
        "description": "Optional birth date used to infer sun sign when the sign is not stated directly.",
        "form": "llm",
    },
    {
        "name": "target_date",
    ...
    {
        "name": "period",
        "description": "Optional period: daily, weekly, or monthly. Defaults to daily.",
        "form": "llm",
    },
    {
        "name": "focus_area",
        "description": "Optional focus such as love, career, finance, health, energy, or general.",
        "form": "llm",
    },
]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Import, publish, and register the AskCrystal horoscope workflow as a Dify workflow tool."
    )
    ...
    parser.add_argument("--publish-marked-name", default="Horoscope workflow", help="Release marker name shown in Dify workflow history.")
