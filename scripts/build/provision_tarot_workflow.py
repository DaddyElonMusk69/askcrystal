...
WORKFLOW_TOOL_DESCRIPTION = (
    "Chooses a tarot spread, generates or normalizes the draw, and returns a structured reflective reading."
)
...
WORKFLOW_TOOL_PARAMETERS = [
    ...
    {
        "name": "context_anchor",
        "description": "Optional recent concrete detail that should ground the reading.",
        "form": "llm",
    },
]
