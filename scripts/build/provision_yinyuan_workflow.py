...
DEFAULT_DSL_PATH = REPO_ROOT / "services" / "dify-agent" / "dsl" / "askcrystal-yinyuan-workflow-2026-04-26.dsl.yml"
...
WORKFLOW_TOOL_PARAMETERS = [
    {
        "name": "question",
        "description": "The user's relationship or romantic timing question.",
        "form": "llm",
    },
    {
        "name": "person_a",
        "description": "Optional profile for the user, such as birth date, birth year, zodiac, or a short relationship context.",
        "form": "llm",
    },
    {
        "name": "person_b",
        "description": "Optional profile for the comparison person when the user wants compatibility guidance.",
        "form": "llm",
    },
]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Import, publish, and register the AskCrystal yinyuan workflow as a Dify workflow tool."
    )
    ...
    parser.add_argument("--publish-marked-name", default="Yinyuan workflow", help="Release marker name shown in Dify workflow history.")
