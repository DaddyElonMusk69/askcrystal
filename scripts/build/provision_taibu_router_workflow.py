...
DEFAULT_DSL_PATH = REPO_ROOT / "services" / "dify-agent" / "dsl" / "askcrystal-taibu-router-workflow-2026-04-26.dsl.yml"
WORKFLOW_TOOL_NAME = "workflow_taibu_structured_divination_router"
WORKFLOW_TOOL_LABEL = "Taibu Structured Divination Router"
WORKFLOW_TOOL_DESCRIPTION = (
    "Routes mixed AskCrystal divination requests into one supported primary method and returns the next suggested workflow."
)
...
WORKFLOW_TOOL_PARAMETERS = [
    {
        "name": "user_query",
        "description": "Raw user request to route into one supported method.",
        "form": "llm",
    },
    {
        "name": "available_methods",
        "description": "Optional comma-separated supported method list. Leave empty to use defaults.",
        "form": "llm",
    },
]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Import, publish, and register the AskCrystal Taibu router as a Dify workflow tool."
    )
    ...
    parser.add_argument("--publish-marked-name", default="Taibu router", help="Release marker name shown in Dify workflow history.")
