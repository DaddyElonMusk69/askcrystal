...
This folder stores the portable, version-controlled AskCrystal assets that should survive beyond the local `dify-local/` runtime.
...
The local runtime remains under `dify-local/`.
